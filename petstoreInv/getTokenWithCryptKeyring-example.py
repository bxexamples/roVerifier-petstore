...
"""
*  This file:/bisos/git/bxRepos/bxexamples/roVerifier-petstore/petstoreInv/getTokenWithCryptKeyring-example.py :: [[elisp:(org-cycle)][| ]]
...
__icmName__ = "getTokenWithCryptKeyring-example"
####+END:

####+BEGIN: bx:global:timestamp:version-py :style "date"
__version__ = "201909040220"
####+END:
...
####+END:
    ...
    icmParams.parDictAdd(
        parName='accessKey',
        parDescription="Access Key",
        parDataType=None,
        parDefault=None,
        parChoices=[],
        parScope=icm.ICM_ParamScope.TargetParam,
        argparseShortOpt=None,
        argparseLongOpt='--accessKey',
        )

    icmParams.parDictAdd(
        parName='secretKey',
        parDescription="Secret Key",
        parDataType=None,
        parDefault=None,
        parChoices=[],
        parScope=icm.ICM_ParamScope.TargetParam,
        argparseShortOpt=None,
        argparseLongOpt='--secretKey',
        )
...
####+BEGIN: bx:icm:python:cmnd:subSection :title "Imported: cryptKeyring Examples"
        """
**   [[elisp:(org-cycle)][| ]] [[elisp:(org-show-subtree)][|=]] [[elisp:(show-children 10)][|V]] [[elisp:(bx:orgm:indirectBufOther)][|>]] [[elisp:(bx:orgm:indirectBufMain)][|I]] [[elisp:(blee:ppmm:org-mode-toggle)][|N]] [[elisp:(org-top-overview)][|O]] [[elisp:(progn (org-shifttab) (org-content))][|C]] [[elisp:(delete-other-windows)][|1]]          *Imported: cryptKeyring Examples*  [[elisp:(org-cycle)][| ]]  [[elisp:(org-show-subtree)][|=]] 
"""
####+END:
...
####+BEGIN: bx:icm:python:cmnd:subSection :title "Get Token"
        """
**   [[elisp:(org-cycle)][| ]] [[elisp:(org-show-subtree)][|=]] [[elisp:(show-children 10)][|V]] [[elisp:(bx:orgm:indirectBufOther)][|>]] [[elisp:(bx:orgm:indirectBufMain)][|I]] [[elisp:(blee:ppmm:org-mode-toggle)][|N]] [[elisp:(org-top-overview)][|O]] [[elisp:(progn (org-shifttab) (org-content))][|C]] [[elisp:(delete-other-windows)][|1]]          *Get Token*  [[elisp:(org-cycle)][| ]]  [[elisp:(org-show-subtree)][|=]] 
"""
####+END:

        icm.cmndExampleMenuChapter('*Get Token With accessKey/secretKey*')
        ...
        icm.cmndExampleMenuChapter('*Get Token For Keyring User*')

        
        cmndName = "getTokenForKeyringUser"
        ...
        def thisBlock():
            cps = cpsInit(); setRsrc(cps)
            cmndArgs = "";
            icm.ex_gCmndMenuItem(cmndName, cps, cmndArgs, verbosity='none', comment="> current.token")
        thisBlock()
...
####+BEGIN: bx:icm:python:section :title "ICM-Commands: getToken"
"""
*  [[elisp:(beginning-of-buffer)][Top]] ############## [[elisp:(blee:ppmm:org-mode-toggle)][Nat]] [[elisp:(delete-other-windows)][(1)]]    *ICM-Commands: getToken*  [[elisp:(org-cycle)][| ]]  [[elisp:(org-show-subtree)][|=]] 
"""
####+END:


####+BEGIN: bx:icm:python:cmnd:classHead :cmndName "getTokenForKeyringUser" :comment "" :parsMand "rsrc" :parsOpt "" :argsMin "0" :argsMax "0" :asFunc "" :interactiveP ""
"""
*  [[elisp:(org-cycle)][| ]] [[elisp:(org-show-subtree)][|=]] [[elisp:(show-children 10)][|V]] [[elisp:(bx:orgm:indirectBufOther)][|>]] [[elisp:(bx:orgm:indirectBufMain)][|I]] [[elisp:(blee:ppmm:org-mode-toggle)][|N]] [[elisp:(org-top-overview)][|O]] [[elisp:(progn (org-shifttab) (org-content))][|C]] [[elisp:(delete-other-windows)][|1]]  ICM-Cmnd       :: /getTokenForKeyringUser/ parsMand=rsrc parsOpt= argsMin=0 argsMax=0 asFunc= interactive=  [[elisp:(org-cycle)][| ]]
"""
class getTokenForKeyringUser(icm.Cmnd):
...
####+BEGIN: bx:icm:python:cmnd:classHead :cmndName "getToken" :comment "" :parsMand "accessKey secretKey"  :argsMin "0" :argsMax "0" :asFunc "" :interactiveP ""
"""
*  [[elisp:(org-cycle)][| ]] [[elisp:(org-show-subtree)][|=]] [[elisp:(show-children 10)][|V]] [[elisp:(bx:orgm:indirectBufOther)][|>]] [[elisp:(bx:orgm:indirectBufMain)][|I]] [[elisp:(blee:ppmm:org-mode-toggle)][|N]] [[elisp:(org-top-overview)][|O]] [[elisp:(progn (org-shifttab) (org-content))][|C]] [[elisp:(delete-other-windows)][|1]]  ICM-Cmnd       :: /getToken/ parsMand=accessKey secretKey parsOpt= argsMin=0 argsMax=0 asFunc= interactive=  [[elisp:(org-cycle)][| ]]
"""
class getToken(icm.Cmnd):
    cmndParamsMandatory = [ 'accessKey', 'secretKey', ]
    cmndParamsOptional = [ ]
    cmndArgsLen = {'Min': 0, 'Max': 0,}
    ...
    def cmnd(self,
        interactive=False,        # Can also be called non-interactively
        accessKey=None,         # or Cmnd-Input
        secretKey=None,         # or Cmnd-Input
    ):
        cmndOutcome = self.getOpOutcome()
        if interactive:
            if not self.cmndLineValidate(outcome=cmndOutcome):
        ...
        callParamsDict = {'accessKey': accessKey, 'secretKey': secretKey, }
        if not icm.cmndCallParamsValidate(callParamsDict, interactive, outcome=cmndOutcome):
            return cmndOutcome
        accessKey = callParamsDict['accessKey']
        secretKey = callParamsDict['secretKey']

####+END:

        token = getTokenInterface.obtainToken(
            accessKey,
            secretKey,
        )
